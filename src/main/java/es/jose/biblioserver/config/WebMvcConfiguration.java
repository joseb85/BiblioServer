package es.jose.biblioserver.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"es.jose.biblioserver"})
@EnableJpaRepositories(basePackages = {"es.jose.biblioserver.repositories"})
